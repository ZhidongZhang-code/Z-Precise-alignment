...
def run_clustalo(input_file, output_file, num_threads=8):
    """
    ...
    """
    command = f"clustalo --infile={input_file} -o {output_file} --threads {num_threads} --force"
    os.system(command)
...
def main(args):
    ...
    run_clustalo(merged_file, clustal_output_file, num_threads)
